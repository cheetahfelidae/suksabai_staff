...
<html class="no-js" lang="en">
    ...
    <body>
        <div class="hide-for-print">
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="row collapse">
                                                ...
                                                <div class="small-10 columns">
                                                    <input type="text" id="arriv-input" placeholder="คลิกปุ่มขวาเพื่อเลือกวันที่" required />
                                                    <small class="error">กรุณาระบุวันที่เข้าพัก</small>
                                                </div>
                                                <div class="small-2 columns">
                                                    <a role="button" tabindex="0" id="arriv-butt" class="button noPadding postfix"><i class="fa fa-calendar"></i></a>
                                                </div>
                                            </div>
                                            <div class="row collapse">
                                                <label for="depar-input">เดินทางออก</label>
                                                <div class="small-10 columns">
                                                    <input type="text" id="depar-input" placeholder="คลิกปุ่มขวาเพื่อเลือกวันที่" required />
                                                    <small class="error">กรุณาระบุวันที่เดินทางออก</small>
                                                </div>
                                                <div class="small-2 columns">
                                                    <a role="button" tabindex="0" id="depar-butt" class="button noPadding postfix"><i class="fa fa-calendar"></i></a>
                                                </div>
                                            </div>
                                            <div class="row collapse">
                                                <div class="small-12 columns">
                        ...
                        <div class="panel noRightPadding noTopBottomPadding withTransparent">
                            ...
                            <div class="tabs-content">
                                ...
                                <section role="tabpanel" aria-hidden="false" class="content active" id="selectDates-tab">
                                        ...
                                        <div class="small-12 columns">
                                            <form>
                                                <fieldset>
                                                    ...
                                                    <div class="row collapse">
                                                        <div class="small-2 columns">
                                                            <a class="button tiny left" id="prev-calendar-butt"><i class="fa fa-chevron-left fa-lg"></i></a>
                                                        </div>
                                                        <div class="small-8 columns">
                                                            <h3 class="text-center"><strong id="calendar-title"></strong></h3>
                                                        </div>
                                                        <div class="small-2 columns">
                                                            <a class="button tiny right" id="next-calendar-butt"><i class="fa fa-chevron-right fa-lg"></i></a>
                                                        </div>
                                                    </div>
                                                    <div id='calendar'></div>
                                                </fieldset>
                                    ...
                                    <div class="row collapse">
                                        <div class="small-12 columns">
                                            <button type="submit" form="arrivDeparForm" class="noBottomMargin withTopMargin right">ต่อไป &nbsp;<i class="fa fa-chevron-right fa-lg"></i></button>
                                        </div>
                                    </div>
                                </section>
                                ...
                                <section role="tabpanel" aria-hidden="true" class="content" id="selectedRoomsRates-tab">
                                    ...
                                    <div class="row collapse">
                                        <div class="small-12 columns">
                                            <button type="button" class="noBottomMargin withTopMargin left" data-reveal-id="back-toSelectDates-reveal"><i class="fa fa-chevron-left fa-lg"></i>&nbsp; ก่อนหน้า</button>
                                        </div>
                                    </div>
                                </section>
                                ...
                                <section role="tabpanel" aria-hidden="true" class="content" id="guest-form-tab">
                                    <div class="row collapse">
                                        <div class="small-12 columns">
                                            ...
                                            <form accept-charset="UTF-8" class="search" id="ls_form" name="ls_form">
                                                <fieldset>
                                                    <legend>ค้นหาข้อมูลผู้พัก &nbsp;<span class="withInfoColor">(กรณีผู้พักเก่า)</span></legend>
                                                    <div class="row collapse">
                                                        ...
                                                        <div class="small-10 large-11 columns">
                                                            <div class="row collapse">
                                                                <div class="small-12 columns">
                                                                    ...
                                                                    <input type="text" name="ls_query" id="ls_query" style="width: 500px;" placeholder="กรอกชื่อจริงเพื่อค้นหา" autocomplete="off" maxlength="<?php echo Config::getConfig('maxInputLength'); ?>">
                                                                </div>
                                                            </div>
                                                            <div class="row collapse">
                                                ...
                                                <fieldset>
                                                    ...
                                                    <div class="row collapse">
                                                        ...
                                                        <div class="small-8 large-4 columns end">
                                                            <select id="title-guest-form-tab" onchange="showOtherTitles( this.value );" required />
                                                                <!-- list will go here -->
                                                            </select>
                                                            <small class="error">กรุณาเลือกคำนำหน้า</small>
                                                        </div>
                                                        <div class="small-8 small-offset-2 large-4 large-offset-0 columns end" style="display:none;" id="otherTitle-column-guest-form-tab">
                                                            <input type="text" placeholder="คำนำหน้า" id="otherTitle-guest-form-tab" maxlength="25" required />
                                                            <small class="error">กรุณากรอกคำนำหน้า</small>
                                                        </div>
                                                    </div>
                                                    <div class="row collapse">
                                                        <div class="small-10 small-offset-2 large-5 large-offset-1 columns">
                                                            <input id="firstName-guest-form-tab" type="text" name="firstName" placeholder="ชื่อจริง" maxlength="40" required />
                                                            <small class="error">กรุณากรอกชื่อให้ถูกต้อง</small>
                                                        </div>
                                                        <div class="small-10 small-offset-2 large-5 large-offset-0 columns end">
                                                            <input id="lastName-guest-form-tab" type="text" name="lastName" placeholder="นามสกุล" maxlength="40" required />
                                                    ...
                                                    <div class="row collapse">
                                                        ...
                                                        <div class="small-10 large-5 columns">
                                                            <input id="email-guest-form-tab" name="email" placeholder="อีเมล์" maxlength="50" type="email" />
                                                        ...
                                                        <div class="small-10 large-4 columns end">
                                                            <input id="tel-guest-form-tab" name="phone" placeholder="เบอร์โทรศัพท์ 9 หรือ 10 หลัก" type="tel" pattern="[0][0-9]{8,9}" maxlength="10" required />
                                                    ...
                                                    <div class="row collapse">
                                                        ...
                                                        <div class="small-10 large-5 columns">
                                                            <input id="address-guest-form-tab" name="address" type="text" placeholder="บ้านเลขที่, ชื่อถนน" maxlength="50" required />
                                                            <small class="error">กรุณากรอกที่อยู่ให้ถูกต้อง</small>
                                                        </div>
                                                        <div class="small-10 small-offset-2 large-4 large-offset-0 columns end">
                                                            <select id="province-guest-form-tab" name="province" onchange="getThailandInfo('amphur', '-guest-form-tab', this.value, phpUrl)" required >
                                                                <!-- list will go here -->
                                                            </select>
                                                    ...
                                                    <div class="row collapse">
                                                        <div class="small-10 small-offset-2 large-4 large-offset-1 columns">
                                                            <select id="amphur-guest-form-tab" name="amphur" onchange="getThailandInfo('district', '-guest-form-tab', this.value, phpUrl)" required >
                                                                <!-- list will go here -->
                                                            </select>
                                                    ...
                                                    <div class="row collapse">
                                                        <div class="small-10 large-5 columns">
                                                            <label>หมายเลขประจำตัวผู้เสียภาษีอากร
                                                                <input type="text" placeholder="จำนวน 13 หลัก" id="taxNumber-guest-form-tab" pattern="[0-9]{13}" maxlength="13" />
                                                            </label>
                                                    ...
                                                    <div class="row collapse">
                                                        <div class="small-12 columns">
                                                            <textarea id="otherDetails-guest-form-tab" placeholder="ข้อมูลอื่นๆ.."></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="row collapse" id="formTools-row" style="display: none;">
                                                        <div class="small-12 columns">
                                                            <button type="button" class="alert withTopMargin noBottomMargin left" id="initialiseForm-butt-guest-form-tab">เคลียร์ &nbsp;<i class="fa fa-eraser fa-lg"></i></button>
                                                            <button type="button" class="warning withTopMargin noBottomMargin right" id="editableForm-butt-guest-form-tab">แก้ไข &nbsp;<i class="fa fa fa-pencil-square-o fa-lg"></i></button>
                                                        </div>
                                                    </div>
                                                </fieldset>
                                            </form>
                                    ...
                                    <div class="row collapse">
                                        <div class="small-12 columns">
                                            <button type="button" class="noBottomMargin withTopMargin left" data-reveal-id="back-toRoomsRatesSelection-reveal"><i class="fa fa-chevron-left fa-lg"></i>&nbsp; ก่อนหน้า</button>
                                            <button type="submit" form="guest-form" class="noBottomMargin withTopMargin right">ต่อไป &nbsp;<i class="fa fa-chevron-right fa-lg"></i></button>
                                        </div>
                                    </div>
                                </section>
                                <!-- *************************** End of Guest Form ******************* -->
                                ...
                                <section role="tabpanel" aria-hidden="true" class="content" id="confirmation-tab">
                                    <div class="row collapse">
                                        <div class="small-12 columns">
                                            <form>
                                                <fieldset>
                                                    <legend>ข้อมูลผู้พัก &nbsp;<span class="withInfoColor" id="formLegend-confirmation-tab"></span></legend>
                                                    <div class="row collapse">
                                                        <div class="small-2 large-1 columns">
                                                            <span class="prefix"><i class="fa fa-user"></i></span>
                                                        </div>
                                    ...
                                    <div class="row collapse">
                                        <div class="small-12 columns">
                                            <button type="button" class="noBottomMargin withTopMargin left" id="back-toEntGuDetailsTab"><i class="fa fa-chevron-left fa-lg"></i>&nbsp; ก่อนหน้า</button>
                                            <button type="button" class="success noBottomMargin withTopMargin right" id="confirm-butt">ยืนยัน &nbsp;<i class="fa fa-check-circle fa-lg"></i></button>
                                        </div>
                                    </div>
                                </section>
            ...
            <div id="back-toSelectDates-reveal" class="reveal-modal small" data-reveal aria-labelledby="back-toSelectDates-title" aria-hidden="true" role="dialog">
                <h2 id="back-toSelectDates-title" class="withWarningColor"><i class="fa fa-exclamation-circle fa-lg"></i>&nbsp; ยืนยันการดำเนินการ</h2>
            ...
            <!-- no room available -->
            <div id="noRoomAvail-reveal" class="reveal-modal small" data-reveal aria-labelledby="noRoomAvail-title" aria-hidden="true" role="dialog">
            ...
            <div id="back-toRoomsRatesSelection-reveal" class="reveal-modal small" data-reveal aria-labelledby="back-toSelectedRoomsRatesTitle" aria-hidden="true" role="dialog">
                <h2 id="back-toSelectedRoomsRatesTitle" class="withWarningColor"><i class="fa fa-exclamation-circle fa-lg"></i>&nbsp; ยืนยันการดำเนินการ</h2>
                ...
                <a class="button" role="button" id="back-toSelectedRoomsRates-butt"><i class="fa fa-chevron-left fa-lg"></i>&nbsp; ย้อนกลับ</a>
                <a class="close-reveal-modal" aria-label="Close">&#215;</a>
            </div>
            <!-- booking into database successfully -->
            <div id="bookingSuccess-reveal" class="reveal-modal small" data-reveal aria-labelledby="bookingSuccess-title" aria-hidden="true" role="dialog">
                <h2 id="bookingSuccess-title" class="withSuccessColor"><i class="fa fa-check-circle fa-lg"></i>&nbsp; บันทึกข้อมูลสำเร็จ</h2>
        ...
        <div class="show-for-print">
            ...
            <div class="panel noBottomMargin noLeftRightBorder">
                <ul class="no-bullet">
                    ...
                    <li><strong>เชคเอ้าท์ได้<ins>ไม่เกิน</ins> :</strong></li>
